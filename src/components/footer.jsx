  ...
  return (
    <>
      ...
      >
        ...
        <SearchBar />
        <Flex gap={{base: 8, md: "11.25rem"}} marginBlockStart={{base: 5, md: '2.6875rem'}} w={{base: '100%', md: 'unset'}} justifyContent={'space-between'}>
          <Stack spacing={4}>
            <Heading
              as={"h5"}
            ...
            <Stack fontFamily={"Open Sans"} spacing={6} fontSize={{base: 'small', md: 'medium'}}>
          ...
          <Stack spacing={4} display={{base: 'none', lg: 'flex' }}>
            ...
            <Stack fontFamily={"Open Sans"} spacing={6}>
              <Link _hover={{textDecoration: 'none'}}>Terms & Conditions</Link>
